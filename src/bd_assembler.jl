...
"""
function assemble_left_bd_regular!(du, idx_x, i, idx_u, pb, cl, fl, sl, pl, ql, frac, type_check_c)
...
"""
"""
function assemble_left_bd_singular!(du, idx_x, i,idx_u, pb, cl, fl, sl, type_check_c)
...
"""
"""
function assemble_right_bd_regular!(du, idx_x, i, idx_u, idx_quad, pb, cl, fl, sl, pr, qr, frac, type_check_c)
...
"""
"""
function assemble_right_bd_singular!(du, idx_x, i, idx_u, idx_quad, pb, cl, fl, sl, pr, qr, frac, type_check_c)
    if qr[i] ≠ 0 && cl[i] !== zero(type_check_c)
