...
"""
"""
function assemble_left_bd!(du::T5, u::T6, idx_x, idx_u, pb::ProblemDefinition{m, npde, singular}, cl::T1, fl::T2, sl::T3, pl, ql,
                           frac, type_check_c::T4) where {T1, T2, T3, T4, T5, T6, m, npde, singular}
...
"""
"""
function assemble_left_bd_regular!(du::T5, idx_x, i, idx_u, pb::ProblemDefinition{m, npde, singular}, cl::T1, fl::T2, sl::T3, pl,
                                   ql, frac, type_check_c::T4) where {T1, T2, T3, T4, T5, m, npde, singular}
...
"""
"""
function assemble_left_bd_singular!(du::T5, idx_x, i, idx_u, pb::ProblemDefinition{m, npde, singular}, cl::T1, fl::T2, sl::T3,
                                    type_check_c::T4) where {T1, T2, T3, T4, T5, m, npde, singular}
...
"""
"""
function assemble_right_bd!(du::T5, u::T6, idx_x, idx_u, pb::ProblemDefinition{npdm, npde, singulare}, cl::T1, fl::T2, sl::T3, pr,
                            qr, frac, type_check_c::T4) where {T1, T2, T3, T4, T5, T6, m, npde, singular}
...
"""
"""
function assemble_right_bd_regular!(du::T5, idx_x, i, idx_u, idx_quad, pb::ProblemDefinition{m, npde, singular}, cl::T1, fl::T2,
                                    sl::T3, pr, qr, frac, type_check_c::T4) where {T1, T2, T3, T4, T5, m, npde, singular}
...
"""
"""
function assemble_right_bd_singular!(du::T5, idx_x, i, idx_u, idx_quad, pb::ProblemDefinition{m, npde, singular}, cl::T1, fl::T2,
                                     sl::T3, pr, qr, frac, type_check_c::T4) where {T1, T2, T3, T4, T5, m, npde, singular}
    if qr[i] ≠ 0 && cl[i] !== zero(type_check_c)
        du[i + idx_u - 1] = (pr[i] +
